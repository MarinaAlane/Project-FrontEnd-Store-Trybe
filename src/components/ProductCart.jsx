  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>
          <button data-testid="product-increase-quantity" onClick={ this.productIncrease }>+</button>
          <button data-testid="product-decrease-quantity" onClick={ this.productDecrease }>-</button>
          <button>X</button>
